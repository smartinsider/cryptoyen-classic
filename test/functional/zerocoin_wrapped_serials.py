#!/usr/bin/env python3
# Copyright (c) 2019 The YEN Core developers
...
from fake_stake.base_test import ZIJA_FakeStakeTest

class zYENwrappedSerialsTest(ZIJA_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zYENs..." % DENOM_TO_USE)
