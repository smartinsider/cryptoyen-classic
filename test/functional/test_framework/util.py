...
def initialize_datadir(dirname, n):
    ...
    with open(os.path.join(datadir, "cryptoyen.conf"), 'w', encoding='utf8') as f:
        f.write("regtest=1\n")
...
def get_auth_cookie(datadir):
    user = None
    password = None
    if os.path.isfile(os.path.join(datadir, "cryptoyen.conf")):
        with open(os.path.join(datadir, "cryptoyen.conf"), 'r', encoding='utf8') as f:
            for line in f:
