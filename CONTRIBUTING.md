Contributing to YEN Core
============================

The YEN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the YEN Core project, and is not to be
confused with overall YEN Network Protocol consensus changes.

Whether a pull request is merged into YEN Core rests with the project merge
...
Patches that change YEN consensus rules are considerably more involved than
...
Where a patch set proposes to change the YEN consensus, it must have been
...
The project leader is the release manager for each YEN Core release.
