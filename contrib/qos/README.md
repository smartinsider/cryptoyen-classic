...
This means one can have an always-on cryptoyend instance running, and another local cryptoyend/cryptoyen-qt instance which connects to this node and receives blocks from it.
