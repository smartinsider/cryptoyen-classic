...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cryptoyen-cli.cpp \
           src/cryptoyen-tx.cpp \
           src/cryptoyen.cpp \
           src/db.cpp \
           ...
           src/qt/cryptoyen.cpp \
           src/qt/cryptoyenstrings.cpp \
...
RESOURCES += src/qt/cryptoyen.qrc src/qt/cryptoyen_locale.qrc

TRANSLATIONS += src/qt/locale/cryptoyen_bg.ts \
                src/qt/locale/cryptoyen_de.ts \
                src/qt/locale/cryptoyen_en.ts \
                src/qt/locale/cryptoyen_es.ts \
                src/qt/locale/cryptoyen_fi.ts \
                src/qt/locale/cryptoyen_fr.ts \
                src/qt/locale/cryptoyen_it.ts \
                src/qt/locale/cryptoyen_ja.ts \
                src/qt/locale/cryptoyen_pl.ts \
                src/qt/locale/cryptoyen_pt.ts \
                src/qt/locale/cryptoyen_ru.ts \
                src/qt/locale/cryptoyen_sk.ts \
                src/qt/locale/cryptoyen_sv.ts \
                src/qt/locale/cryptoyen_vi.ts \
                src/qt/locale/cryptoyen_zh_CN.ts \
                src/qt/locale/cryptoyen_zh_TW.ts
