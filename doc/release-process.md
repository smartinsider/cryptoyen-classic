...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/smartinsider/cryptoyen/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/smartinsider/cryptoyen-detached-sigs.git
...
### Build and sign YEN Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit cryptoyen=v${VERSION} ../cryptoyen/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/smartinsider/cryptoyen/releases/new) with a link to the archived release notes.
