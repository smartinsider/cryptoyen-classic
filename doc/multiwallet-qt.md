...
In order to support loading of multiple wallets in cryptoyen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptoyen.cpp.
...
Changes to cryptoyen.cpp
----------------------
cryptoyen.cpp is the entry point into cryptoyen-qt, and as such, will require some minor modifications to provide hooks for
