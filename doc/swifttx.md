...
This mechanism has been integrated into Bitcore-Node-YEN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/YEN-Project/insight-api-cryptoyen#web-socket-api](https://github.com/YEN-Project/insight-api-cryptoyen#web-socket-api) 
* API: [https://github.com/YEN-Project/insight-api-cryptoyen#swifttx-transactions](https://github.com/YEN-Project/insight-api-cryptoyen#swifttx-transactions) 
...
By default, the YEN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the YEN Core daemon:
