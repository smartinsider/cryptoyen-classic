...
YEN now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<cryptoyen_address\> \<monthly_payment_cryptoyen\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ YEN, _12_ times over the course of a year totaling _24000_ YEN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<cryptoyen_address\> \<monthly_payment_cryptoyen\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` YEN.
