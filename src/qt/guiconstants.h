...
/* CryptoYen GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "YEN"
#define QAPP_ORG_DOMAIN "cryptoyen.icu"
#define QAPP_APP_NAME_DEFAULT "YEN-Qt"
#define QAPP_APP_NAME_TESTNET "YEN-Qt-testnet"
