...
/** Utility functions used by the YEN Qt UI.
 */
namespace GUIUtil
{
...
// Render YENC addresses in monospace font
...
// Parse "cryptoyen:" URI into recipient object, return true on successful parsing
