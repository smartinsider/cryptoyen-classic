...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(THEYEN);
    unitlist.append(mYEN);
    unitlist.append(uYEN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case THEYEN:
        return QString("cryptoyen");
    case mYEN:
        return QString("mcryptoyen");
    case uYEN:
        return QString::fromUtf8("ucryptoyen");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case uYEN:
            return QString("Micro-YEN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        ...
        case uYEN:
            return QString("Micro-TestYEN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
