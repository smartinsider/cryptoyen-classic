...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* YEN features */
        {"cryptoyen", "masternode", &masternode, true, true, false},
        {"cryptoyen", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptoyen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptoyen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryptoyen", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cryptoyen", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cryptoyen", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cryptoyen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptoyen", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptoyen", "startmasternode", &startmasternode, true, true, false},
        {"cryptoyen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptoyen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptoyen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptoyen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptoyen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptoyen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptoyen", "mnbudget", &mnbudget, true, true, false},
        {"cryptoyen", "preparebudget", &preparebudget, true, true, false},
        {"cryptoyen", "submitbudget", &submitbudget, true, true, false},
        {"cryptoyen", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cryptoyen", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cryptoyen", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cryptoyen", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cryptoyen", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cryptoyen", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cryptoyen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptoyen", "checkbudgets", &checkbudgets, true, true, false},
        {"cryptoyen", "mnsync", &mnsync, true, true, false},
        {"cryptoyen", "spork", &spork, true, true, false},
        {"cryptoyen", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> cryptoyen-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37702/\n";
}
