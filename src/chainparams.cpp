...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
      (0, uint256("0000082cafc7c356e4ec3d9c25b00c7b463edc466fa5c8fcfdbcba59c34f2c72"))
      (67, uint256("0000000e2a7810730912805f04730eb3a1f41fadbbfe567c2013c0269caf8b88"))
    ;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553689552, // * UNIX timestamp of last checkpoint block
    69,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1553333333; // October 17, 2017 4:30:00 AM
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("test1.cryptoyen.icu", "test1.cryptoyen.icu"));
        vSeeds.push_back(CDNSSeedData("test2.cryptoyen.icu", "test2.cryptoyen.icu"));
