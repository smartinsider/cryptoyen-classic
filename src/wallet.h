...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 YEN at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zYEN send
enum ZerocoinSpendStatus {
    ...
    ZZIJA_SPENT_USED_ZYEN = 14,                      // Coin has already been spend
...
public:
    ...
    void ZCryptoYenBackupWallet();
    bool GetZerocoinKey(const CBigNum& bnSerial, CKey& key);
    bool CreateZYENOutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
    ...
    */
    ...
    CzYENWallet* zwalletMain;

    bool fFileBacked;
    bool fWalletUnlockAnonymizeOnly;
    std::string strWalletFile;
    bool fBackupMints;
    std::unique_ptr<CzYENTracker> zpivTracker;
    ...
    void setZWallet(CzYENWallet* zwallet)
    {
        zwalletMain = zwallet;
        zpivTracker = std::unique_ptr<CzYENTracker>(new CzYENTracker(strWalletFile));
    }

    CzYENWallet* getZWallet() { return zwalletMain; }
    ...
    void setZCryptoYenAutoBackups(bool fEnabled)
    {
    ...
    /** zYEN reset */
    boost::signals2::signal<void()> NotifyzYENReset;
