...
//YTMCMD
extern UniValue gettop(const UniValue& params, bool fHelp); // in rpc/ytm.cpp
extern UniValue setvideo(const UniValue& params, bool fHelp);
extern UniValue videoactivate(const UniValue& params, bool fHelp);
extern UniValue ytmpooltotal(const UniValue& params, bool fHelp);
extern UniValue ytmpoolreward(const UniValue& params, bool fHelp);
extern UniValue ytmtotalview(const UniValue& params, bool fHelp);
extern UniValue ytmnextpayment(const UniValue& params, bool fHelp);
extern UniValue videoinfo(const UniValue& params, bool fHelp);
extern UniValue videoinfoglobal(const UniValue& params, bool fHelp);
