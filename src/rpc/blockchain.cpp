...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in cryptoyen\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of cryptoyen addresses\n"
            "     \"cryptoyenaddress\"   	 	(string) cryptoyen address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
...
{
    UniValue ret(UniValue::VOBJ);
    ret.push_back(Pair("mined", "122fdfdfeef"));
    ret.push_back(Pair("nextpayment", "10981"));
    ret.push_back(Pair("bytes", 21));
    return ret;
}
...
//YTMCMD
UniValue gettop(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "gettop ( verbose )\n"
            ...
            "\nExamples\n" +
            HelpExampleCli("gettop", "true") + HelpExampleRpc("gettop", "true"));
...
UniValue setvideo(const UniValue& params, bool fHelp)
{	
	bool fVerbose = false;
...
UniValue videoactivate(const UniValue& params, bool fHelp)
{
	bool fVerbose = false;
	return mempoolToJSON(fVerbose);
}
UniValue ytmpooltotal(const UniValue& params, bool fHelp)
{
	bool fVerbose = false;
	return mempoolToJSON(fVerbose);
}
UniValue ytmpoolreward(const UniValue& params, bool fHelp)
{
	bool fVerbose = false;
	return mempoolToJSON(fVerbose);
}
UniValue ytmtotalview(const UniValue& params, bool fHelp)
{
	bool fVerbose = false;
	return mempoolToJSON(fVerbose);
	
}
UniValue ytmnextpayment(const UniValue& params, bool fHelp)
{
	bool fVerbose = false;
	return mempoolToJSON(fVerbose);
}
UniValue videoinfo(const UniValue& params, bool fHelp)
{
	bool fVerbose = false;
	return mempoolToJSON(fVerbose);
}
UniValue videoinfoglobal(const UniValue& params, bool fHelp)
{
	//bool fVerbose = false;
	//return mempoolToJSON(fVerbose);
	return ytmInfo();
